...
TARGET_ALIAS="${1:-rhc-v2}"
DEV_HUB_ALIAS="${DEV_HUB_ALIAS:-gkSfdcDevHub}"
...
echo "Deploying Record Health Check V2 core, examples, layouts, and list views..."
...
sf apex run \
  --target-org "$TARGET_ALIAS" \
  --file scripts/apex/verifyV2Demo.apex

echo
echo "V2 Account relationship and risk demo org is ready."
