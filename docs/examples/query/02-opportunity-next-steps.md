...
| --- | --- | --- |
| **Developer Name** | [`DeveloperName`](../../metadata/fields-rule.md#developer-name-developername) | `Open_Opportunities_Have_Next_Steps` |
| **Label** | [`MasterLabel`](../../metadata/fields-rule.md#label-masterlabel) | Open Opportunities Have Next Steps |
...
| **Check Title** | [`CheckTitle__c`](../../metadata/fields-rule.md#check-title-checktitle__c) | Open Opportunities Are Ready for Review |
| **Evaluation Type** | [`EvaluationType__c`](../../metadata/fields-rule.md#evaluation-type-evaluationtype__c) | Verify with a query |
| **Source Query** | [`SourceQuery__c`](../../metadata/fields-rule.md#source-query-sourcequery__c) | `SELECT NextStep FROM Opportunity WHERE AccountId = {!record.Id} AND IsClosed = false` |
| **Source Query Field** | [`SourceQueryField__c`](../../metadata/fields-rule.md#source-query-field-sourcequeryfield__c) | `NextStep` |
...
| **Comparison Operator** | [`ComparisonOperator__c`](../../metadata/fields-rule.md#comparison-operator-comparisonoperator__c) | Is not empty |
...
| Setup field | API&nbsp;name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Value |
| --- | --- | --- |
| **Check Description** | [`CheckDescription__c`](../../metadata/fields-rule.md#check-description-checkdescription__c) | Confirms that every visible open Opportunity has a Next Step; skips Accounts with none. |
...
| **Message When Failed** | [`FailureMessage__c`](../../metadata/fields-rule.md#message-when-failed-failuremessage__c) | One or more open Opportunities have no Next Step. Add the next planned action to each deal that needs attention. |
| **Message When Unable To Evaluate** | [`UnableToEvaluateMessage__c`](../../metadata/fields-rule.md#message-when-unable-to-evaluate-unabletoevaluatemessage__c) | Unable to check open Opportunity Next Step. Confirm the user can read the queried fields. |
...
| **Fix Message** | [`FixMessage__c`](../../metadata/fields-rule.md#fix-message-fixmessage__c) | Review open Opportunities and enter Next Step on every deal that still needs one. |
