...
Set the component's **Check Set** to `Account_Examples_Compare_Two_Queries`. See the [example catalog](../../index.md#sample-check-set-packages) for every Check Set and what it contains.
