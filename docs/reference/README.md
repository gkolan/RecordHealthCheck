...
| Why was a value rejected or completed text returned `ERROR`? | [Reference: Field limits](reference-fields-limits.md) | Salesforce storage limits, Framework resolved limits, and remedies |
