...
| Check Set | Checkbox | true/false | [`IsActive__c`](../metadata/fields-check-set.md#active-isactive__c), [`PublishErrorLogEvent__c`](../metadata/fields-check-set.md#publish-error-log-event-publisherrorlogevent__c), [`PublishRunEvent__c`](../metadata/fields-check-set.md#publish-run-event-publishrunevent__c), [`ShowDiagnostics__c`](../metadata/fields-check-set.md#show-diagnostics-showdiagnostics__c), [`StopOnSystemError__c`](../metadata/fields-check-set.md#stop-after-a-system-error-stoponsystemerror__c) |
