...
[Display value format: Currency](reference-display-value-format.md#currency).
...
[Reference: Localization](reference-localization.md).

## What this page does not cover

- Named Credential, External Service, or REST API compatibility: Record Health Check has no REST
  API surface. See [Architecture: Out of scope](reference-architecture.md#16-out-of-scope).
