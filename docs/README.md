...
| --- | --- | --- |
| Understand the Framework before installing it | [How Record Health Check works](installation/01-how-it-works.md) | Check Sets, Rules, result meanings, and when to use a health check |
...
| Review security before production | [Security and data access](reference/framework/security.md) | USER_MODE, Permission Sets, diagnostics, persistence, and plugins |
...
| [FAQ](guides/faq.md) | You need a short answer to a common Framework question |
...
| [Security and data access](reference/framework/security.md) | USER_MODE, Permission Sets, diagnostics, persistence, and plugins |
| [Compatibility](reference/framework/compatibility.md) | Editions, Lightning Experience, API version, and known limits |
| [Data model](reference/framework/data-model.md) | ERD for Check Sets, Rules, and lifecycle events |
| [Localization](reference/framework/localization.md) | Translation Workbench scope and locale-aware display |
...
| [Architecture](reference/framework/architecture.md) | Published Framework architecture: principles, layers, runtime, security, limits, ownership |
| [Apex classes](reference/apex/README.md) | What each production Apex class owns and when to use it |
| [Configuration identity](reference/framework/configuration-identity.md) | Exact Qualified API Name rules and the Framework/examples package boundary |
