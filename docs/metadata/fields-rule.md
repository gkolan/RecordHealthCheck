...
Consult this reference when configuring one Rule in Custom Metadata Types. Choose the Rule's
**Evaluation Type** first; that choice determines which evaluation fields are relevant. Fields for
the other Evaluation Types should remain blank.
