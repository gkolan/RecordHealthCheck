...
- The public synchronous response contract is pre-1.0 (`0.1`) and grows additively. Lifecycle event contract V1 is opt-in and Publish After Commit.
...
npm test -- --runInBand
sf project deploy start --source-dir force-app --test-level RunLocalTests --target-org <validation-org> --wait 30
