...
> - For every field's size, default, help text, and examples, use the [Rule field reference](../metadata/rule-fields.md).

## Contract

| Setup field | API name | Requirement |
| --- | --- | --- |
| **Evaluation Type** | [`EvaluationType__c`](../metadata/rule-fields.md#evaluation-type-evaluationtype__c) | **Verify with a query** — `QUERY` |
| **Source Query** | [`SourceQuery__c`](../metadata/rule-fields.md#source-query-sourcequery__c) | Primary SOQL template; required except list-membership mode |
| **Source Query Field** | [`SourceQueryField__c`](../metadata/rule-fields.md#source-query-field-sourcequeryfield__c) | Selected field or aggregate alias; blank for bare `COUNT()` |
| **How To Read Query Results** | [`QueryResultHandling__c`](../metadata/rule-fields.md#how-to-read-query-results-queryresulthandling__c) | Converts returned rows into the value or row decision |
| **Comparison Operator** | [`ComparisonOperator__c`](../metadata/rule-fields.md#comparison-operator-comparisonoperator__c) | Required operator compatible with the selected mode |
| **Expected Value Comes From** | [`ExpectedValueSource__c`](../metadata/rule-fields.md#expected-value-comes-from-expectedvaluesource__c) | Required when the operator needs a right-side value |
...
| --- | --- | --- |
| **Fixed value** | `FIXED_VALUE` | [Expected Value (Fixed)](../metadata/rule-fields.md#expected-value-fixed-expectedfixedvalue__c) |
| **Record formula** | `RECORD_FORMULA` | [Expected Value (Formula)](../metadata/rule-fields.md#expected-value-formula-expectedrecordformula__c) |
| **Comparison query** | `COMPARISON_QUERY` | [Comparison Query](../metadata/rule-fields.md#comparison-query-comparisonquery__c) and, when needed, Comparison Query Field |
...
documented under [Comparison Operator](../metadata/rule-fields.md#comparison-operator-comparisonoperator__c).
...
value in [Value to find in the list (formula)](../metadata/rule-fields.md#value-to-find-in-the-list-formula-findinlistformula__c),
...
| --- | --- | --- |
| **If Query Finds No Records** | [`NoRowsResult__c`](../metadata/rule-fields.md#if-query-finds-no-records-norowsresult__c) | Explicitly returns Pass, Fail, Skip, or Unable to evaluate for multi-row/list modes |
| **If Field Value Is Empty** | [`EmptyValueHandling__c`](../metadata/rule-fields.md#if-field-value-is-empty-emptyvaluehandling__c) | Ignore the row, compare blank, or force no match |
| **Max Query Rows (1-2000)** | [`MaxQueryRows__c`](../metadata/rule-fields.md#max-query-rows-1-2000-maxqueryrows__c) | Defaults to `200`; maximum `2000` |
...
requires a new contract version. No V2 Query field is currently deprecated.

## Related

- [Query example](query-example.md)
