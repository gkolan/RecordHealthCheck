...
| **Source Query** | [`SourceQuery__c`](../metadata/rule-fields.md#source-query-sourcequery__c) | Required left-side SOQL template |
...
| **Comparison Query** | [`ComparisonQuery__c`](../metadata/rule-fields.md#comparison-query-comparisonquery__c) | Required right-side SOQL template |
| **Comparison Query Field** | [`ComparisonQueryField__c`](../metadata/rule-fields.md#comparison-query-field-comparisonqueryfield__c) | Selected field or aggregate alias; blank for bare `COUNT()` |
| **How To Read Query Results** | [`QueryResultHandling__c`](../metadata/rule-fields.md#how-to-read-query-results-queryresulthandling__c) | **One row or aggregate** or **Compare as lists** |
| **Comparison Operator** | [`ComparisonOperator__c`](../metadata/rule-fields.md#comparison-operator-comparisonoperator__c) | Operator compatible with the selected mode |
...
| --- | --- | --- |
| **If Query Finds No Records** | [`NoRowsResult__c`](../metadata/rule-fields.md#if-query-finds-no-records-norowsresult__c) | Determines the outcome when a required list/query side has no records |
| **If Field Value Is Empty** | [`EmptyValueHandling__c`](../metadata/rule-fields.md#if-field-value-is-empty-emptyvaluehandling__c) | Ignores, preserves as blank, or forces no match for empty selected values |
| **Max Query Rows (1-2000)** | [`MaxQueryRows__c`](../metadata/rule-fields.md#max-query-rows-1-2000-maxqueryrows__c) | Applies to returned rows; defaults to `200`, maximum `2000` |
...
- Both templates support current-record merge tokens such as `{!record.Id}` and parent paths.
...
values, duplicate list values, case differences, the configured row cap, and access denied to each
...
operator, or reason requires a new contract version. No V2 Compare-two-queries field is deprecated.

## Related

- [Compare two queries example](compare-two-queries-example.md)
