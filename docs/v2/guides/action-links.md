...
Action links give users a next step when a Rule fails. Opening a link can navigate to a record,
related list, report, Knowledge article, external site, or a prefilled create page.

They are configured on the Rule with:

- [**Action Label** (`ActionLabel__c`)](../metadata/rule-fields.md#action-label-actionlabel__c)
- [**Action URL** (`ActionUrl__c`)](../metadata/rule-fields.md#action-url-actionurl__c)
- [**Fix Message** (`FixMessage__c`)](../metadata/rule-fields.md#fix-message-fixmessage__c)
