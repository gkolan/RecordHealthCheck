...
> **On this page**
>
> Learn how Check Sets and Rules work together, choose an Evaluation Type, configure behavior, and troubleshoot results.
...
| Guide users toward a correction | [Action links and Fix Message](action-links.md) | Add Fix Message and safe Action URL guidance to failed Rules |
...
[Formula reference](../examples/formula/reference.md) for the complete contract.
...
[Customer handoff](../examples/query/01-customer-contact.md); use the [Query reference](../examples/query/reference.md)
...
[Compare two queries reference](../examples/compare-two-queries/reference.md) for the complete
contract.
...
[Apex reference](../examples/apex/reference.md), [Recent Account activity](../examples/apex/01-recent-activity.md),
...
| Custom automation runs slowly or hits limits | Call caps or too many Rules × records | Stay within `MAX_RECORDS_PER_CALL` (200) and `MAX_EVALUATIONS_PER_CALL` (15); prefer `runSet` with a focused Check Set; see [Apex API](../integration/apex-api/public-api.md) or [Flow actions](../integration/flow-actions.md). |
