...
Record the future method's callers, input limits, running user, expected side effect, and failure
...
Keep the existing future method as a thin forwarding boundary and prevent new callers from
